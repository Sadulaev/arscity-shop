...
const PersonalData = () => {
    return (
        <div className="w-screen px-4 flex flex-col gap-8 md:px-12 lg:w-[1370px] mx-auto md:mt-20">
            ...
            <div className="flex flex-col gap-4 text-justify">
                ...
                <p className="text-xl flex flex-col gap-4">
                    ...
                    персональных данных, предпринимаемые Супаев Анзор Лечаевич
                    (далее — Оператор).
                    ...
                    <span className="pl-10">
                        ...
                        посетителях веб-сайта https://ars-city.ru.
                    </span>
                </p>
                ...
                <p className="text-xl flex flex-col gap-4">
                    ...
                    <span className="pl-10">
                        2.3. Веб-сайт — совокупность графических и
                        информационных материалов, а также программ для ЭВМ и
                        баз данных, обеспечивающих их доступность в сети
                        интернет по сетевому адресу https://ars-city.ru.
                    </span>
                    <span className="pl-10">
                    ...
                    <span className="pl-10">
                        ...
                        орган, юридическое или физическое лицо, самостоятельно
                        или совместно с другими лицами организующие и/или
                    ...
                    <span className="pl-10">
                        ...
                        Пользователю веб-сайта https://ars-city.ru.
                    </span>
                    <span className="pl-10">
                ...
                <p className="text-xl flex flex-col gap-4">
                    <span className="pl-10">
                        ...
                        персональных данных достоверные информацию и/или
                        документы, содержащие персональные данные; — в случае
                        отзыва субъектом персональных данных согласия на
                        обработку персональных данных, а также, направления
                        ...
                        Законе о персональных данных; — самостоятельно
                        определять состав и перечень мер, необходимых и
                        достаточных для обеспечения выполнения обязанностей,
                        предусмотренных Законом о персональных данных и
                        принятыми в соответствии с ним нормативными правовыми
                        актами, если иное не предусмотрено Законом о
                    ...
                    <span className="pl-10">
                        ...
                        запроса; — публиковать или иным образом обеспечивать
                        неограниченный доступ к настоящей Политике в отношении
                        обработки персональных данных; — принимать правовые,
                        ...
                        действий в отношении персональных данных; — прекратить
                        передачу (распространение, предоставление, доступ)
                        персональных данных, прекратить обработку и уничтожить
                        персональные данные в порядке и случаях, предусмотренных
                        Законом о персональных данных; — исполнять иные
                        обязанности, предусмотренные Законом о персональных
                        данных.
                    </span>
                </p>
                <h2 className="text-2xl font-bold mt-8">
                ...
                <p className="text-xl flex flex-col gap-4">
                    <span className="pl-10">
                        ...
                        прав; — выдвигать условие предварительного согласия при
                        обработке персональных данных в целях продвижения на
                        рынке товаров, работ и услуг; — на отзыв согласия на
                        обработку персональных данных, а также, на направление
                        ...
                        обработке его персональных данных; — на осуществление
                    ...
                    <span className="pl-10">
                        ...
                        себе, либо сведения о другом субъекте персональных
                ...
                <div className="pl-10">
                    <table className="border border-gray-300">
                        ...
                        <tr className="border border-gray-300">
                            <th className="border border-gray-300 p-2">Персональные данные</th>
                            <th className="border border-gray-300 p-2 font-normal">
                        ...
                        <tr className="border border-gray-300">
                            <th className="border border-gray-300 p-2">Правовые основания</th>
                            <th className="border border-gray-300 p-2 font-normal">
                                <ul className="pl-4 list-disc">
                                    <li>договоры, заключаемые между оператором и
                                субъектом персональных данных</li>
                                </ul>
                                
                            </th>
                        </tr>
                        <tr>
                            <th className="border border-gray-300 p-2">Виды обработки персональных данных</th>
                            <th className="border border-gray-300 p-2 font-normal">
                                <ul className="pl-4 list-disc">
                                    <li>Отправка информационных писем на адрес
                ...
                <p className="text-xl flex flex-col gap-4">
                    ...
                    <span className="pl-10">
                        ...
                        осуществления возложенных законодательством Российской
                    ...
                    <span className="pl-10">
                        ...
                        заключения договора по инициативе субъекта персональных
                        данных или договора, по которому субъект персональных
                        данных будет являться выгодоприобретателем или
                        поручителем.
                    </span>
                    <span className="pl-10">
                        7.5. Обработка персональных данных необходима для
                        осуществления прав и законных интересов оператора или
                        третьих лиц либо для достижения общественно значимых
                ...
                <p className="text-xl flex flex-col gap-4">
                    ...
                    <span className="pl-10">
                        ...
                        субъектом персональных данных дано согласие Оператору на
                        передачу данных третьему лицу для исполнения
                    ...
                    <span className="pl-10">
                        ...
                        самостоятельно, путем направления Оператору уведомление
                        на адрес электронной почты Оператора anzor.beno@bk.ru с
                    ...
                    <span className="pl-10">
                        ...
                        действующим законодательством. Пользователь может в
                        ...
                        Оператора anzor.beno@bk.ru с пометкой «Отзыв согласия на
                    ...
                    <span className="pl-10">
                        ...
                        соответствии с их Пользовательским соглашением и
                        Политикой конфиденциальности. Субъект персональных
                    ...
                    <span className="pl-10">
                        ...
                        обработку или условия обработки (кроме получения
                        доступа) персональных данных, разрешенных для
                        распространения, не действуют в случаях обработки
                        персональных данных в государственных, общественных и
                    ...
                    <span className="pl-10">
                        ...
                        персональных данных, отзыв согласия субъектом
                        персональных данных или требование о прекращении
                        обработки персональных данных, а также выявление
                ...
                <p className="text-xl flex flex-col gap-4">
                    <span className="pl-10">
                        ...
                        трансграничной передаче персональных данных обязан
                        ...
                        уведомление направляется отдельно от уведомления о
                ...
                <h2 className="text-2xl font-bold mt-8">12. Заключительные положения</h2>
                <p className="text-xl flex flex-col gap-4">
                    <span className="pl-10">
                        2.1. Пользователь может получить любые разъяснения по
                        интересующим вопросам, касающимся обработки его
                        персональных данных, обратившись к Оператору с помощью
                        электронной почты anzor.beno@bk.ru.
                    </span>
                    <span className="pl-10">
                    ...
                    <span className="pl-10">
                        ...
                        <Link href="https://ars-city.ru/personal-data">
                            https://ars-city.ru/personal-data
                        </Link>
                        .
                    </span>
                </p>
